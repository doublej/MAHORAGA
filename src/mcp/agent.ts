...
import {
  ...
  enableKillSwitch,
  disableKillSwitch,
} from '../storage/d1/queries/risk-state';
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  failure({ code: ErrorCode.UNAUTHORIZED, message: String(error) }),
                  null,
                  2
                ),
              },
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  failure({ code: ErrorCode.PROVIDER_ERROR, message: String(error) }),
                  null,
                  2
                ),
              },
    ...
    this.server.tool(
      ...
      async ({ symbol, qty, percentage }) => {
        try {
          ...
          const order = await alpaca.trading.closePosition(
            symbol,
            qty,
              ...
              content: [
                {
                  type: 'text' as const,
                  text: JSON.stringify(
                    failure({ code: ErrorCode.MARKET_CLOSED, message: 'Market closed' }),
                    null,
                    2
                  ),
                },
  ...
  private registerRiskTools(
    ...
    this.server.tool('risk-status', 'Get current risk status and limits', {}, async () => {
      try {
        ...
        const result = success({
          kill_switch: {
            active: riskState.kill_switch_active,
            reason: riskState.kill_switch_reason,
          },
          daily_loss: {
          ...
          cooldown: {
            active: riskState.cooldown_until
        ...
        try {
              ...
              content: [
                {
                  ...
                  text: JSON.stringify(
                    failure({
                      code: ErrorCode.INVALID_INPUT,
                      message: "Type 'CONFIRM_RESUME_TRADING'",
                    }),
                    null,
                    2
                  ),
              ...
              content: [
                {
                  type: 'text' as const,
                  text: JSON.stringify(
                    failure({ code: ErrorCode.UNAUTHORIZED, message: 'Invalid secret' }),
                    null,
                    2
                  ),
                },
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ message: 'Kill switch disabled' }), null, 2),
              },
            ],
          };
        } catch (error) {
  ...
  private registerUtilityTools() {
    ...
    this.server.tool('catalog-list', 'List all available tools', {}, async () => {
      const catalog = [
        ...
        {
          category: 'Orders',
          tools: ['orders-preview', 'orders-submit', 'orders-list', 'orders-cancel'],
        },
        {
          category: 'Risk',
          tools: [
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ journal_id: journalId, message: 'Trade logged' }),
                  null,
                  2
                ),
              },
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ message: 'Outcome logged' }), null, 2),
              },
            ],
          };
        } catch (error) {
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ entries, stats, active_rules: rules.length }),
                  null,
                  2
                ),
              },
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ summary, entries_analyzed: entries.length }),
                  null,
                  2
                ),
              },
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ message: 'Preferences saved' }), null, 2),
              },
            ],
          };
        } catch (error) {
    ...
    this.server.tool(
      ...
      async () => {
        try {
          ...
          return {
            content: [
              { type: 'text' as const, text: JSON.stringify(success({ preferences }), null, 2) },
            ],
          };
        } catch (error) {
          return {
      ...
      async ({ symbol }) => {
        ...
        try {
          ...
          const result = success({
            ...
            change_pct:
              ((snapshot.daily_bar.c - snapshot.prev_daily_bar.c) / snapshot.prev_daily_bar.c) *
              100,
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ gainers, losers }), null, 2),
              },
            ],
          };
        } catch (error) {
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ count: Object.keys(quotes).length, quotes }),
                  null,
                  2
                ),
              },
    ...
    this.server.tool(
      ...
      async ({ symbol, timeframe }) => {
        try {
          ...
          return {
            content: [
              { type: 'text' as const, text: JSON.stringify(success(technicals), null, 2) },
            ],
          };
        } catch (error) {
          return {
      ...
      async ({ symbols, timeframe }) => {
        try {
          ...
          for (const sym of symbols) {
            try {
              const bars = await alpaca.marketData.getBars(sym.toUpperCase(), timeframe, {
                limit: 250,
              });
              if (bars.length >= 20) {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ count: results.length, results }), null, 2),
              },
            ],
          };
        } catch (error) {
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ event_id: eventId, message: 'Event ingested' }),
                  null,
                  2
                ),
              },
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ count: events.length, events }), null, 2),
              },
            ],
          };
        } catch (error) {
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ ...classified, event_id: eventId }), null, 2),
              },
            ],
          };
        } catch (error) {
        ...
        try {
          ...
          return {
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(success({ count: news.length, news }), null, 2),
              },
            ],
          };
        } catch (error) {
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ news_id: newsId, message: 'News indexed' }),
                  null,
                  2
                ),
              },
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ ...scraped, financial_data: financialData }),
                  null,
                  2
                ),
              },
            ...
            content: [
              {
                ...
                text: JSON.stringify(
                  failure({
                    ...
                    message: 'Options provider not configured',
                  }),
                  null,
                  2
                ),
            ...
            content: [
              {
                type: 'text' as const,
                text: JSON.stringify(
                  success({ underlying: underlying.toUpperCase(), expirations }),
                  null,
                  2
                ),
              },
              ...
              content: [
                {
                  ...
                  text: JSON.stringify(
                    failure({
                      code: ErrorCode.INVALID_INPUT,
                      message: 'Invalid options contract symbol',
                    }),
                    null,
                    2
                  ),
